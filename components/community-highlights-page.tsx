...
export function CommunityHighlightsPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Community highlights have been updated.",
      });
    } catch (error) {
      toast({
        title: "Error",
        description: "Failed to save community highlights.",
        variant: "destructive",
      });
    } finally {
      setSaving(false);
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Manage the images displayed in the Community Highlights mosaic on the product detail page.
        </CardDescription>
      </CardHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {imageFields.map((field, index) => (
            <div key={field} className="space-y-2">
              <label className="font-medium">Highlight Image {index + 1}</label>
